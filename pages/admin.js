...
export default function AdminPage() {
  ...
  // controla se ainda está checando o login
  ...
  // 🔐 Checa se o administrador está logado
  useEffect(() => {
  ...
  // Só busca casos depois de confirmar login
  useEffect(() => {
    if (!authChecking) {
      loadCases();
    }
  ...
  // Enquanto checa login, mostra só um loading simples
  if (authChecking) {
    return (
      <main className="page">
        <div className="shell">
